...
const tierUnits = {
  ...
  rocketart: { role: 'siege',    hp: 120, armor: 1, dmg: 36, range: 11,  cooldown: 4.5, speed: 2.4, sight: 10, pop: 4, size: 0.5, trainTime: 34, cost: { p: 220, s: 160 }, building: 'siege', domain: 'land', projectile: 'shell', splash: 0.9, minRange: 3, bonus: { building: 2.0, infantry: 1.5 } },
...
const commonBuildings = {
  ...
  tower:    { hp: 550,  armor: 6, w: 1, h: 1, cost: { p: 70,  s: 90 },  buildTime: 26, trains: [], attack: { dmg: 15, range: 8, cooldown: 1.0, projectile: 'arrow' }, hotkey: 'T',
...
export const ERAS = {
  antiquity: era({
    ...
    nodes: { mine: { name: 'Zlatý důl', amount: 60000, perTrip: 10, tripTicks: 22 }, secondary: { name: 'Les', kind: 'trees', amount: 1200, perTrip: 20, chopTicks: 8, chopHits: 5 } },
  ...
  ww2: era({
    ...
    nodes: { mine: { name: 'Ropné pole', amount: 60000, perTrip: 10, tripTicks: 22 }, secondary: { name: 'Les', kind: 'trees', amount: 1200, perTrip: 20, chopTicks: 8, chopHits: 5 } },
    ...
    factions: [
      { id: 'germany', name: 'Německo', leader: 'Guderian', desc: 'Blitzkrieg: tanky +15 % pancíř, +5 % rychlost.',    mods: { cavalry: { armor: 1.15, speed: 1.05 } },
      ...
      { id: 'poland',  name: 'Polsko',  leader: 'Anders', desc: 'Odhodlání: pěchota -20 % doba výcviku, +10 % HP.',  mods: { infantry: { trainTime: 0.8, hp: 1.1 } },
        unitNames: { worker: 'Saper', infantry: 'Pěšák', ranged: 'Kulometčík', cavalry: '7TP', siege: 'Houfnice wz. 14', ship: 'ORP Torpédoborec' } },
      { id: 'ussr',    name: 'SSSR',    leader: 'Žukov', desc: 'Masa: pěchota -20 % cena, ropa +10 % výnos.',      mods: { infantry: { cost: 0.8 }, economy: { mine: 1.1 } },
    ...
    buildings: {
      ...
      tower:    { ...commonBuildings.tower,    name: 'Bunkr',           sprite: 'ww2_bunker',   desc: 'Kulometné hnízdo, střílí automaticky.', attack: { dmg: 6, range: 8, cooldown: 0.3, projectile: 'bullet' } },
  ...
  scifi: era({
    ...
    nodes: { mine: { name: 'Plazmový krystal', amount: 60000, perTrip: 10, tripTicks: 20 }, secondary: { name: 'Houbový háj', kind: 'fungus', amount: 750, perTrip: 10, chopTicks: 7, chopHits: 5 } },
    ...
    units: {
      ...
      heavycav: { ...tierUnits.heavycav,   name: 'Těžký hover tank', sprite: 'sf_heavytank', desc: 'Silně pancéřovaný, dvojité dělo. Vznášedlo – projede i mělkou vodou.', range: 5, projectile: 'plasma', domain: 'hover' },
    ...
    buildings: {
      ...
      tower:    { ...commonBuildings.tower,    name: 'Plazmová věž',       sprite: 'sf_tower',    desc: 'Automatická plazmová obrana.', attack: { dmg: 16, range: 8.5, cooldown: 0.9, projectile: 'plasma' } },
